			...
			<div className='grid grid-cols-1 md:grid-cols-2 gap-5'>
				...
				>
					<Form>
						...
						<div className='w-full flex flex-row gap-4 px-3 mb-6 md:mb-0'>
						...
						<div className='w-full px-3 mb-6 md:mb-0'>
							...
							<Field
								...
								name='color'
								placeholder='Color'
								onKeyUp={(e) => setContentColor(e.target.value)}
								style={{
...
export async function getServerSideProps(context: Params) {
	...
	if (context.query.slug) {
		if (context.query.type === 'blog') {
			content = getPostBySlug(context.query.slug, [
				'slug',
				'createdDate',
				'editedDate',
				'title',
			...
			content = getProjectBySlug(context.query.slug, [
				'slug',
				'createdDate',
				'editedDate',
				'title',
