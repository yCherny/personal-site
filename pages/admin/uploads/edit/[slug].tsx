      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <Formik
          ...
          validationSchema={Yup.object({
            ...
            color: Yup.string().max(7, "Must be 7 characters or less"),
        ...
        >
          ...
          <Form>
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col w-full gap-5">
                <div className="w-full px-3 mb-6 md:mb-0">
                  ...
                  <Field
                    ...
                    name="color"
                    placeholder="Color"
                    onKeyUp={(e: any) => setContentColor(e.target.value)}
                    style={{
                      backgroundColor: contentColor ?? "black",
                    }}
                  />
                  <div className="text-red-500 font-bold text-sm">
                ...
                <div className="w-full px-3 mb-6 md:mb-0">
                  {Array.from({length: tagCount}).map((_item, index) => (
                    <div key={index}>
                      <label
                        htmlFor={`tags[${index}]`}
                        className="block uppercase tracking-wide text-gray-700 dark:text-gray-300 text-xs font-bold mb-2"
              ...
              <Text className="text-2xl font-bold">External Links</Text>
              ...
              <Text className="text-2xl font-bold">Cover Image</Text>
              {imageURL && (
                <Image
              ...
              <div className="flex flex-col w-full gap-5">
                ...
                <div className="w-full px-3 mb-6 md:mb-0">
                  ...
                  <Field
                    ...
                    value={content?.coverImage.copyrightLink}
                  />
                  <div className="text-red-500 font-bold text-sm">
                ...
                <div className="flex flex-ror gap-4">
                  ...
                  {content?.slug && (
                    <Button
                      ...
                      loading={isDeleting}
                      disabled={isSubmitting || isDeleting}
                      onClick={() => deleteData(content.slug)}
                    >
                      Delete
                    </Button>
                  )}
