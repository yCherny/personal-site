    ...
    <Fragment>
      <Head>
        ...
        <meta
          ...
          key={"desc"}
        />
        <meta property="og:title" content="Yegor Chernyshev | Portfolio" />
        <meta
          property="og:description"
          content="Various projects made by Yegor Chernyshev"
        />
        <meta property="og:url" content="https://yegor.codes/portfolio" />
      </Head>
      <div className="max-w-7xl mx-auto">
        <Header
          titlePrimary={"Portfol"}
          titleSecondary={".io"}
          subtitle={"precious trinkets I made, work experience and the like"}
        />
        <StickyNavBar>
          <FilterPanel
