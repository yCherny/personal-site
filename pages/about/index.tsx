  ...
  return (
    <Fragment>
      <Head>
        ...
        <meta property="og:description" content="About Yegor Chernyshev" />
        ...
        <div className="grid gap-10 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 mb-20">
          ...
          <div className="flex flex-col col-span-1 order-first sm:order-last">
            <div className="flex flex-col border rounded-lg bg-white items-center p-5 gap-3 drop-shadow-md dark:bg-[#2F2050] dark:border-[#413D57]">
              <h3 className="font-bold dark:text-white">Yegor Chernyshev</h3>
              <Image
                ...
                priority
              />
              <p className="text-gray-500 text-md">A photo of Yegor in 2023</p>
              <table className="table-auto border-separate border-spacing-4">
                <tbody>
                  <tr className="align-top dark:text-white">
                    ...
                    <td>Baruch College (BA) New York University (MS)</td>
                  </tr>
                  <tr className="align-top dark:text-white">
                    <td className="font-semibold">Occupations</td>
                    <td>Software engineer, lifelong learner, night-owl</td>
                  </tr>
                </tbody>
              </table>
            </div>
