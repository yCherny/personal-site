...
function Landing() {
	return (
		<div className='fixed -translate-y-1/2 -translate-x-1/2 left-1/2 md:left-20 flex flex-col gap-2 text-white dark:text-white z-50 items-center md:-translate-x-0 md:w-1/3 md:items-start top-24 md:top-1/2 md:gap-5'>
			<Image
				src={'/assets/logo.png'}
				alt={'Blog post image'}
				width={80}
			...
			<p className='text-lg text-gray-400 dark:text-gray-600 hidden md:inline'>
